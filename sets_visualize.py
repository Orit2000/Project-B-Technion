...
trainset = torch.load("cache/trainset_n32_e035_1arc_v3_cropped_k50_keep_n0.00125.pt", map_location="cpu")
validset = torch.load("cache/validset_n32_e035_1arc_v3_cropped_k50_keep_n0.00125.pt", map_location="cpu")
testset = torch.load("cache/testset_n32_e035_1arc_v3_cropped_k50_keep_n0.00125.pt", map_location="cpu")
