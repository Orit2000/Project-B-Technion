...
trainset = torch.load(r"./Transformer_Map_Interp/cache/trainset_n32_e035_1arc_v3_cropped_k50_keep_n0.005.pt",weights_only=False)
validset = torch.load(r"./Transformer_Map_Interp/cache/validset_n32_e035_1arc_v3_cropped_k50_keep_n0.005.pt",weights_only=False)
testset = torch.load(r"./Transformer_Map_Interp/cache/testset_n32_e035_1arc_v3_cropped_k50_keep_n0.005.pt",weights_only=False)
